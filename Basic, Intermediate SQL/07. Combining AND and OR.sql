/*
1. Select all rows from the "HumanResources.Employee" table where gender = "F", 
...
/*
2. Streamline your query from Exercise 1 by using an IN statement to replace the OR. 
...
/*
3. Select all rows from the "Person.Person" table where person type = "EM", 
...
/*
4. Modify your query from Exercise 3 such that you are now selecting all rows 
