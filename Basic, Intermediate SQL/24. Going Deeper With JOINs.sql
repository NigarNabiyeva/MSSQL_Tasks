/*
1. Write a query that combines the "FirstName" and "LastName" columns from the "Person.Person" table, 
...
/*
2. Modify your query from Exercise 1 such that you now only pull in phone numbers 
...
/*
3. Modify your query from Exercise 2 to pull in each person's city from the "Person.Address" table. 
