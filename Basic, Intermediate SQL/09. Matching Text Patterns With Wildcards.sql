/*
1. Select all rows from the Person.Person table where 
...
/*
2. Select all people from the Person.Person table with the initials "TLC". 
...
/*
3. Select all rows from the Person.Person table where the first name 
