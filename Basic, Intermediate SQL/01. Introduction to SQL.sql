/*
1. Select the first 3,000 rows from the Person.Person table. 
...
/*
2. Select the first 500 rows from the Sales.SalesOrderHeader table. 
...
/*
3. Select the first 100 rows from the Sales.SalesPerson table. 
