/*
1. Select all rows from the "Purchasing.PurchaseOrderHeader" table 
...
/*
2. Using the BETWEEN keyword, modify your query from Exercise 1 such that 
...
/*
3. Modify your query from Exercise 2 such that you are NOT including $10,000 and $30,000 
