/*
1. Select all rows from the "Production.Product" table where the weight is less than 10 pounds. 
...
/*
2. Modify the "Color" field of your query from Exercise 1 such that 
