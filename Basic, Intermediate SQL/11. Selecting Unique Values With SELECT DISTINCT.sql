/*
1. Produce a list of the unique person types in the "Person.Person" table, sorted in ascending order.
*/
...
/*
2. Produce a list of the unique full names in the "Person.Person" table - 
