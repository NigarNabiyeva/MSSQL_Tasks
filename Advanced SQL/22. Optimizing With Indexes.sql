/* Using indexes, further optimize your solution to the "Optimizing With UPDATE" exercise. You can find the starter code in the
"Optimizing With UPDATE - Exercise Starter Code.sql" file in the Resources for this section.
*/
...
CREATE CLUSTERED INDEX pci_idx1 
ON #PersonContactInfo(BusinessEntityID)
...
CREATE NONCLUSTERED INDEX pci_idx2 
ON #PersonContactInfo(PhoneNumberTypeID)
